...
public class SystemProductDAO {
	
	public static SystemProductDAO intances = new SystemProductDAO();
	 ...
	 * 
	 */
	public int deleteProductById(String seq){
		//session
		Session session = HibernateUtil.getSessionDAO();
		int cnt = 0; 
		Transaction tx = session.beginTransaction();
	 ...
	 * @throws IOException 
	 */
	public SanPhamOutputBean getProductById_2(SanPhamInputBean inputBean){
		Session session = HibernateUtil.getSessionDAO();
		String hql = getSQLProductById_2();
		SanPhamOutputBean outputBean = new SanPhamOutputBean();
		SanPhamOutputRowBean outputRowBean = null;
		try {
			Transaction tx = session.beginTransaction();
	 ...
	 * @throws IOException 
	 */
	public SanPhamOutputBean getProductByIdAndIdDKM(SanPhamInputBean inputBean){
		Session session = HibernateUtil.getSessionDAO();
		String hql = getSQLProductByIdAndIdDotKM(inputBean.getPathJSP());
		SanPhamOutputBean outputBean = new SanPhamOutputBean();
		SanPhamOutputRowBean outputRowBean = null;
		try {
			Transaction tx = session.beginTransaction();
			SQLQuery query = session.createSQLQuery(hql);
			query.setParameter(0, inputBean.getSEQ());
			query.setParameter(1, inputBean.getId_DKM());
			List<Object[]> data = query.list();
			for (Object[] object : data) {
				outputRowBean = new SanPhamOutputRowBean();
				outputRowBean.setIdSanPham(SMSComons.convertString(object[0]));
...
/**
	 ...
	 * @throws IOException 
	 */
	public ImageOutputBean getImage(String table, String SEQ) {
		Session session = HibernateUtil.getSessionDAO();
		String hql = getSQLImage();
	 ...
	 * @return
	 */
	private String getSQLProductById() {
		String tableName = "PRODUCT";
		StringBuffer sb = new StringBuffer();
		sb.append("  SELECT                                 ");
		sb.append("   ID_SP		                            ");
	 ...
	 * @return
	 */
	private String getSQLProductById_2() {
		String tableName = "PRODUCT";
		StringBuffer sb = new StringBuffer();
		sb.append("  SELECT                                 ");
		sb.append("   ID_SP		                            ");
	 ...
	 * @return
	 */
	private String getSQLProductByIdAndIdDotKM(String pathJSP) {
		String tableName = pathJSP+"_PRODUCT";
		StringBuffer sb = new StringBuffer();
		sb.append("  SELECT                                 ");
		sb.append("   ID_SP		                            ");
