	...
	<!-- header-section-ends -->
	    ...
	    <div class="navbar-header">
	        <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
				...
				<div class="logo">
					<h1><a href="/storeManagerSystem/trangChu"><span>E</span> -Trang chủ</a></h1>
				</div>
	    </div>
	</nav>
	<!--/.navbar-->
                                	...
                                	<table class="table table-bordered ">
		                                    ...
		                                    <tbody>
										      ...
										      <tr id="sanPham${items.SEQ }">
										      		<td align="center" style="widows: 80px"><img style="height: 80px;width: 70px;" src="/storeManagerSystem/myImage/trangChu/imageDisplay/${items.SEQ}" alt="" /></td>
													<td>${items.tenSP}</td>
