...
<!-- Mirrored from runecom26.runtime.vn/gioi-thieu/ve-chung-toi.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Jul 2017 10:32:57 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
    <meta charset="UTF-8" />
    <title>Về ch&#250;ng t&#244;i</title>
    <meta content="Về ch&#250;ng t&#244;i" name="description" />
    <meta content="Về ch&#250;ng t&#244;i" name="keywords" />
    ...
    <meta content="Về ch&#250;ng t&#244;i" property="og:description" />
    <meta content="http://runecom26.runtime.vn" property="og:image" />
    <meta content="http://runecom26.runtime.vn/gioi-thieu/ve-chung-toi.html" property="og:url" />
    ...
    <link href="../../static.runtime.vn/App_Themes/RUN026/style.css" rel="stylesheet" type="text/css" />
    <link href="../../static.runtime.vn/App_Themes/RUN026/responsive.css" rel="stylesheet" type="text/css" />
...
<div class="containter">
    <div class="row">
        <div class="col-xs-12 hidden-lg hidden-md hidden-sm">
            <!-- MENU MAIN -->
            <ul id='nav' class='sf-menu-phone'><li><a class='' href='../trang-chu.html'><span>Trang chủ</span></a></li>
<li><a class='' href='../gioi-thieu.html'><span>Giới thiệu</span></a></li>
<li><a class='' href='../san-pham.html'><span>Sản phẩm</span></a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="nav navbar-nav navbar-right topmenu hidden-xs hidden-sm" ng-if="accountLogin!=null">
                    ...
                    <li class="order-check"><a href="/kiem-tra-don-hang.html"><i class="fa fa-pencil-square-o"></i>Kiểm tra đơn hàng</a></li>
                    <li class="order-cart"><a href="/gio-hang.html"><i class="fa fa-shopping-cart"></i>Giỏ hàng</a></li>
                    <li class="webmaster" ng-if="accountLogin.AccountTypeId==1"><a href="/admin"><i class="fa fa-gears"></i>Quản trị website</a></li>
                ...
                <div class="show-mobile hidden-lg hidden-md">
                    ...
                    <div class="quick-user">
                        ...
                        <div class="inner-toggle">
                            ...
                            <ul class="login links" ng-if="accountLogin!=null">
                                <li ng-if="accountLogin.AccountTypeId==1"><a href="/admin"><i class="fa fa-gears"></i> Quản trị website</a></li>
                                <li>
                                    <a href="/thong-tin-tai-khoan.html">{{accountLogin.Email}}</a>
                                </li>
                                <li>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-3 col-xs-12 logo text-center">
                        <a href="../index.html" title="">
                            <img alt="" src="../Uploads/shop150/images/adv/logo-black-magenta.png" class="img-responsive" />
                        </a>
                    </div>
                            ...
                            <div class="input-cat form-search clearfix">
                                <div class="form-search-controls  input-group">
                                    ...
                                    <span class="input-group-btn">
                                        <button class="btn btn-search" title="Search" type="submit" id="btnsearch" value="Search">
                        ...
                        <div class="heading">
                            <a href="/gio-hang.html">
                                <span class="icon">icon</span><span id="cart-total">
                                    ...
                                    sp - {{myCart.TotalAmount|number:0}}đ
                                </span><i class="fa fa-arrow-right"></i>
                            </a>
                        </div>
                        <div class="box-cart-dropdown" ng-if="myCart.ModelSM_OrderDetail.length>0">
                            <div class="box-cart-dropdown-block">
                                <div class="total">
                                    Có <a href="/gio-hang.html"><span>{{myCart.ModelSM_OrderDetail.length}}</span> sản phẩm</a>
                                    trong giỏ.<br />
                                </div>
                                <ul>
                                    <li class="clearfix" ng-repeat="item in myCart.ModelSM_OrderDetail">
                                        <figure class="image">
                                            <a href="/san-pham/{{item.ProductCode}}.html">
                                                <img alt="{{item.ProductName}}" ng-src="{{item.ProductImage}}" class="img-responsive" />
                                            </a>
                                        </figure>
                                        <div class="name">
                                            <a href="/san-pham/{{item.ProductCode}}.html">{{item.ProductName}}</a>
                                            <div>
                                        ...
                                        <span class="remove_link">
                                            <a href="javascript:void(0);" class="remove-cart" ng-click="removeItemCart(item)"><i class="fa fa-times-circle"></i></a>
                                        </span>
                                    </li>
                                </ul>
...
<li class="child"><a href='../san-pham/thoi-trang-nam-3597.html'><span class='menu-icon'><i class='fa '></i></span> <span class='menu-label'>Thời trang nam</span></a><ul><li><a href='../san-pham/ao-thun-nam-3598.html'><span class='menu-icon'><i class='fa fa-check'></i></span> <span class='menu-label'>Áo thun nam</span></a></li>
                        ...
                        <div class="item">
                            ...
                            <div class="toggle-footer">
                                    <ul>
                                                        ...
                                                        <li>
                                                            <a href="../content/qui-dinh-thao-luan.html">
                                                                Qui định thảo luận
                                                            </a>
                                                        </li>
                                                        <li>
...
<script type="text/javascript">
    ...
    function accordion(status)
    {
        ...
        //if(status == 'enable')
        //{
        //    var accordion_selector = '.footer .footer-box h3';
