...
<div id="wrapper">
	...
	<!-- Danh Sach San pham (E) -->
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Danh sách sản phẩm tại hệ thống</h1>
			</div>
			<!-- /.col-lg-12 -->
		</div>
		<!-- /.row -->
		<div class="row" align="right" style="width: 100%">
			<div>
				...
				<button type="button" class="btn btn-info" data-toggle="collapse" data-target="#sanPhamPhanAnh">
				  <i class="glyphicon glyphicon-plus"></i> Chọn sản phẩm
				</button>
		...
		<div id="table-wrapper">
  				<div id="table-scroll">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    <tr>
										<th style="text-align:center;width: 40px;padding-left: 2px;padding-right: 2px;">Chọn</th>
<!-- 										<th style="text-align:center;width: 90px;">Mã SP</th> -->
										...
										<th style="text-align:center; width: 180px;">Loại sản phẩm</th>
                                    </tr>
                                </thead>
...
<%-- 		                                        <td align="center">${items.idSanPham}</td> --%>
					                    		 ...
					                    		 <td style="text-align: right">${items.giaBan }</td>
					                    		 <td>
					                    		 <form:select class="form-control"  path="lst[${status.index}].idLoaiSP">
												    <form:options items="${ProductForm3.lstCategory}" />
												 </form:select>
					                    		 </td>
		                                 </tr>
					                </c:forEach>
		...
		<c:if test="${empty ProductForm3.lst }">
			<div class="panel-body">
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    <tr>
										<th style="width: 40px;padding-left: 2px;padding-right: 2px;font-size: 13px">Chọn</th>
...
<script src="/storeManagerSystem/view/js/sanPhamTrangChu.js"></script>
