...
<head>
    ...
    <meta content="RUNECOM22" property="og:title" />
    <meta content="RUNECOM22" property="og:description" />
    <meta content="http://runecom22.runtime.vn" property="og:image" />
    <meta content="http://runecom22.runtime.vn/trang-chu.html" property="og:url" />
    <meta content="RUNTIME" property="og:site_name" />

    <link href="/storeManagerSystem/view/jsp/template_2/runecom22.runtime.vn/Scripts/bootstrap/css/bootstrap.min.css" rel="stylesheet" />
    <link href="/storeManagerSystem/view/App_Themes/Home/font-awesome.min.css" rel="stylesheet" />
    <link href="/storeManagerSystem/view/App_Themes/Home/common.css" rel="stylesheet" type="text/css" />
    <link href="/storeManagerSystem/view/App_Themes/Home/animate.css" rel="stylesheet" type="text/css" />
    <link href="/storeManagerSystem/view/Scripts/jQuery-ui/jquery-ui.min.css" rel="stylesheet" type="text/css" />

    <script src="/storeManagerSystem/view/Scripts/jQuery/jquery-2.1.4.min.js" type="text/javascript"></script>
    <script src="/storeManagerSystem/view/Scripts/jQuery/jquery-migrate-1.2.1.min.js" type="text/javascript"></script>
    <script src="/storeManagerSystem/view/Scripts/bootstrap/js/bootstrap.min.js"></script>
    <script src="/storeManagerSystem/view/Scripts/jQuery-ui/jquery-ui.min.js" type="text/javascript"></script>

    <script src="/storeManagerSystem/view/Scripts/common/fix-height.js" data-img-box=".image-resize" type="text/javascript"></script>
    <script src="/storeManagerSystem/view/Scripts/common/common.js" type="text/javascript"></script>
    <script src="/storeManagerSystem/view/Scripts/common/jquery.cookie.js" type="text/javascript"></script>
    <script src="/storeManagerSystem/view/Scripts/common/mycard.js" type="text/javascript"></script>
    <script src="/storeManagerSystem/view/Scripts/lazyLoad/jquery.lazyload.min.js" type="text/javascript"></script>

    <script src="/storeManagerSystem/view/Scripts/angularJS/angular.min.js"></script>
    <script src="/storeManagerSystem/view/Scripts/angularJS/angular-sanitize.min.js"></script>
    <script type="text/javascript" src="/storeManagerSystem/view/Scripts/angular-loading-spinner/spin.min.js"></script>
    <script type="text/javascript" src="/storeManagerSystem/view/Scripts/angular-loading-spinner/angular-spinner.min.js"></script>
    <script type="text/javascript" src="/storeManagerSystem/view/Scripts/angular-loading-spinner/angular-loading-spinner.js"></script>
    <script src="/storeManagerSystem/view/app/appMain.js"></script>
    <script src="/storeManagerSystem/view/app/directives/directive.js"></script>
    <script src="/storeManagerSystem/view/app/directives/angular-summernote.js"></script>
    <script src="/storeManagerSystem/view/app/directives/paging.js"></script>
    <script src="/storeManagerSystem/view/app/services/ajaxServices.js"></script>
    <script src="/storeManagerSystem/view/app/services/alertsServices.js"></script>
    <link href="/storeManagerSystem/view/../static.runtime.vn/App_Themes/RUN022/style.css" rel="stylesheet" type="text/css" />
    <link href="/storeManagerSystem/view/../static.runtime.vn/App_Themes/RUN022/responsive.css" rel="stylesheet" type="text/css" />
...
<script src="/storeManagerSystem/view/Scripts/common/login.js" type="text/javascript"></script>
...
<section class="top-link clearfix" ng-controller="moduleController" ng-init="initTopLinkController('Shop','AccountLogin')">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <ul class="nav navbar-nav topmenu-contact">
                    <li><i class="fa fa-phone"></i>Hotline:{{shop.Hotline}}</li>
                </ul>
                <ul class="nav navbar-nav navbar-right topmenu  hidden-xs hidden-sm" ng-if="accountLogin==null">
                    <li class="hotline"><a href="#"><i class="fa fa-phone"></i>Hotline:{{shop.Hotline}}</a></li>
                    <li class="order-check"><a href="/kiem-tra-don-hang.html"><i class="fa fa-pencil-square-o"></i>Kiểm tra đơn hàng</a></li>
                    <li class="order-cart"><a href="/gio-hang.html"><i class="fa fa-shopping-cart"></i>Giỏ hàng</a></li>
                    <li class="account-login"><a href="/dang-nhap.html"><i class="fa fa-sign-in"></i>Đăng nhập </a></li>
                    <li class="account-register"><a href="/dang-ky.html"><i class="fa fa-key"></i>Đăng ký </a></li>
                    ...
                    <div class="col-md-3 col-xs-12 col-sm-12 header-left text-center">
                        <div class="logo">
                            <a href="index.html" title="">
                                <img alt="" src="/storeManagerSystem/view/Uploads/shop139/images/Product/logo.png" class="img-responsive" />
                            </a>
                        </div>
                    </div>
...
<!--Template--
<section ng-controller="moduleController" ng-init="initHeaderController('Shop','MyCart','ProductGroups','Search')">
    <section class="header-banner" ng-if="shop.IsBanner==true" ng-class="{'container': shop.IsFixed==false}">
        <a href="/"><img ng-src="{{shop.BannerImage}}" class="img-responsive"></a>
    </section>
    <section class="header-content clearfix"  ng-if="shop.IsBanner==false">
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-xs-12 col-sm-12 header-left text-center">
                    <div class="logo">
                        <a href="/" title="">
                            <img alt="{{shop.Name}}" ng-src="{{shop.Logo}}" class="img-responsive" />
                        </a>
                    </div>
                </div>
                <div class="col-md-9 col-xs-12 col-sm-12 header-right">
                    ...
                    <div class="search hidden-sm hidden-xs">
                        <div class="input-cat form-search clearfix">
                            <div class="form-search-controls">
                                <input type="text" name="search" id="txtsearch" onblur="if(this.value=='')this.value='Tìm kiếm...'"
                                       onfocus="if(this.value=='Tìm kiếm...')this.value=''"  ng-model="search.Key" />
                                <div class="select-categories">
                                    <select name="lbgroup" id="lbgroup" ng-model="search.ProductGroupId" ng-init="search.ProductGroupId=ProductGroups[0].Id||search.ProductGroupId"
                                            ng-options="item.Id as item.Name for item in ProductGroups"></select>
                                </div>
                            </div>
                            <button class="btn btn-search" title="Search" type="button" id="btnsearch" value="Search">
                                <i class="fa fa-search"></i>
    ...
    <script type="text/javascript">
        ...
        function SearchProduct() {
            ...
            var group = angular.element(document.getElementById('lbgroup')).scope().search.ProductGroupId;
                    ...
                    <nav class="navbar nav-menu">
                        ...
                        <nav class="mobile-menu collapse navbar-collapse" id="mobile-menu">
                            <ul class="menu nav navbar-nav">
                                ...
                                <li class="level0"><a href="/san-pham.html" class=""><span>Sản phẩm</span></a></li>
...
<script src="/storeManagerSystem/view/app/services/moduleServices.js"></script>
<script src="/storeManagerSystem/view/app/controllers/moduleController.js"></script>
    <!--Begin-->
    <link href="/storeManagerSystem/view/Scripts/flexSlider/flexslider.css" rel="stylesheet" type="text/css" />
    <script src="/storeManagerSystem/view/Scripts/flexSlider/jquery.flexslider-min.js" type="text/javascript"></script>
    <div class="flexslider slideshow-content" id="bannerheaderhome" ng-controller="moduleController" ng-init="initSlideshowController('Slideshows')">
        <ul class="slides">
            <li ng-repeat="item in Slideshows">
                <a title="{{item.Name}}" href="%7b%7bitem.html">
...
<link href="/storeManagerSystem/view/Scripts/owl-carousel/owl.carousel.css" rel="stylesheet" />
<link href="/storeManagerSystem/view/Scripts/owl-carousel/owl.theme.css" rel="stylesheet" />
<script src="/storeManagerSystem/view/Scripts/owl-carousel/owl.carousel.min.js"></script>
<script src="/storeManagerSystem/view/app/services/moduleServices.js"></script>
<script src="/storeManagerSystem/view/app/controllers/moduleController.js"></script>
    <!--Begin-->
        ...
        <div class="owl-carousel">
            <ul id="adv-content">
                <li ng-repeat="item in AdvSlides">
                    <a href="%7b%7bitem.html"><img ng-src="{{item.Image}}" alt="{{it.Name}}" class="img-responsive" /></a>
                </li>
            </ul>
    ...
    <section class="product-content clearfix">
        ...
        <div class="product-block product-grid clearfix row">
                ...
                <div class="col-md-3 col-sm-3 col-xs-12 product-item-box">
                    <div class="product-item product-resize">
                        <div class="image image-resize">
                            <a href="san-pham/combo-2-ao-yem-xuan-he.html" title="Combo 2 &#193;o Yếm Xu&#226;n H&#232;">
                                <img src="Uploads/shop139/images/Product/131880_fashion_new.jpg" class="img-responsive" />
                            </a>
                                <span class="promotion">-0%</span>
                        </div>
                        <div class="right-block">
                            <h2 class="name">
                                <a href="san-pham/combo-2-ao-yem-xuan-he.html" title="Combo 2 &#193;o Yếm Xu&#226;n H&#232;">Combo 2 &#193;o Yếm Xu&#226;n H&#232;</a>
                            </h2>
                            <div class="ratings clearfix">
                                <div class="rating-box">
                                    <div class="rating">
                            ...
                            <div class="addtocart-button clearfix">
                                <a class="add-to-cart" href="javascript:void(0)" onclick="AddToCard(2654,1)"><span></span></a>
                                <a class="add-wishlist" href="#"><span></span></a>
                                <a class="add-compare" href="#"><span></span></a>
                            </div>
                        </div>
                ...
                <div class="col-md-3 col-sm-3 col-xs-12 product-item-box">
                    <div class="product-item product-resize">
                        <div class="image image-resize">
                            <a href="san-pham/bo-the-thao-co-gian-tot-summer-hot.html" title="Bộ Thể Thao Co Gi&#227;n Tốt Summer Hot">
                                <img src="Uploads/shop139/images/Product/129725_0_fashion_1.jpg" class="img-responsive" />
                            </a>
                                <span class="promotion">-10%</span>
                        </div>
                        <div class="right-block">
                            <h2 class="name">
                                <a href="san-pham/bo-the-thao-co-gian-tot-summer-hot.html" title="Bộ Thể Thao Co Gi&#227;n Tốt Summer Hot">Bộ Thể Thao Co Gi&#227;n Tốt Summer Hot</a>
                            </h2>
                            <div class="ratings clearfix">
                                <div class="rating-box">
                                    <div class="rating">
                            ...
                            <div class="addtocart-button clearfix">
                                <a class="add-to-cart" href="javascript:void(0)" onclick="AddToCard(2655,1)"><span></span></a>
                                <a class="add-wishlist" href="#"><span></span></a>
                                <a class="add-compare" href="#"><span></span></a>
                            </div>
                        </div>
                ...
                <div class="col-md-3 col-sm-3 col-xs-12 product-item-box">
                    <div class="product-item product-resize">
                        <div class="image image-resize">
                            <a href="san-pham/combo-2-ao-thun-nu-sac-mau-he.html" title="Combo 2 &#193;o Thun Nữ Sắc M&#224;u H&#232;">
                        ...
                        <div class="right-block">
                            <h2 class="name">
                                <a href="san-pham/combo-2-ao-thun-nu-sac-mau-he.html" title="Combo 2 &#193;o Thun Nữ Sắc M&#224;u H&#232;">Combo 2 &#193;o Thun Nữ Sắc M&#224;u H&#232;</a>
                            </h2>
                            <div class="ratings clearfix">
                                <div class="rating-box">
                                    <div class="rating">
                ...
                <div class="col-md-3 col-sm-3 col-xs-12 product-item-box">
                    <div class="product-item product-resize">
                        <div class="image image-resize">
                            <a href="san-pham/quan-jeans-xuat-khau-tre-trung-28013-1.html" title="Quần Jeans Xuất Khẩu Trẻ Trung 28013-1">
                                <img src="Uploads/shop139/images/Product/131536_fashion.jpg" class="img-responsive" />
                            </a>
                                <span class="promotion">-16%</span>
                        </div>
                        <div class="right-block">
                            <h2 class="name">
                                <a href="san-pham/quan-jeans-xuat-khau-tre-trung-28013-1.html" title="Quần Jeans Xuất Khẩu Trẻ Trung 28013-1">Quần Jeans Xuất Khẩu Trẻ Trung 28013-1</a>
                            </h2>
                            <div class="ratings clearfix">
                                <div class="rating-box">
                                    <div class="rating">
                            ...
                            <div class="price">
                                    ...
                                    <span class="price-old">335.000&nbsp;₫</span>
                            </div>
                            <div class="addtocart-button clearfix">
                                <a class="add-to-cart" href="javascript:void(0)" onclick="AddToCard(2657,1)"><span></span></a>
                                <a class="add-wishlist" href="#"><span></span></a>
                                <a class="add-compare" href="#"><span></span></a>
                            </div>
                        </div>
                ...
                <div class="col-md-3 col-sm-3 col-xs-12 product-item-box">
                    <div class="product-item product-resize">
                        <div class="image image-resize">
                            <a href="san-pham/quan-legging-phoi-chan-vay-day-keo.html" title="Quần Legging Phối Ch&#226;n V&#225;y D&#226;y K&#233;o">
                                <img src="Uploads/shop139/images/Product/130948_0_fashion_1.jpg" class="img-responsive" />
                            </a>
                                <span class="promotion">-10%</span>
                        </div>
                        <div class="right-block">
                            <h2 class="name">
                                <a href="san-pham/quan-legging-phoi-chan-vay-day-keo.html" title="Quần Legging Phối Ch&#226;n V&#225;y D&#226;y K&#233;o">Quần Legging Phối Ch&#226;n V&#225;y D&#226;y K&#233;o</a>
                            </h2>
                            <div class="ratings clearfix">
                                <div class="rating-box">
                                    <div class="rating">
                            ...
                            <div class="addtocart-button clearfix">
                                <a class="add-to-cart" href="javascript:void(0)" onclick="AddToCard(2658,1)"><span></span></a>
                                <a class="add-wishlist" href="#"><span></span></a>
                                <a class="add-compare" href="#"><span></span></a>
                            </div>
                        </div>
                ...
                <div class="col-md-3 col-sm-3 col-xs-12 product-item-box">
                    <div class="product-item product-resize">
                        <div class="image image-resize">
                            <a href="san-pham/quan-jeans-lung-nang-dong.html" title="Quần Jeans Lửng Năng Động">
                                <img src="Uploads/shop139/images/Product/fashion_new__131529.jpg" class="img-responsive" />
                            </a>
                                <span class="promotion">-25%</span>
                        </div>
                        <div class="right-block">
                            <h2 class="name">
                                <a href="san-pham/quan-jeans-lung-nang-dong.html" title="Quần Jeans Lửng Năng Động">Quần Jeans Lửng Năng Động</a>
                            </h2>
                            <div class="ratings clearfix">
                                <div class="rating-box">
                                    <div class="rating">
                            ...
                            <div class="price">
                                    <span class="price-new">240.000&nbsp;₫</span>
                                    <span class="price-old">320.000&nbsp;₫</span>
                            </div>
                            <div class="addtocart-button clearfix">
                                <a class="add-to-cart" href="javascript:void(0)" onclick="AddToCard(2659,1)"><span></span></a>
                                <a class="add-wishlist" href="#"><span></span></a>
                                <a class="add-compare" href="#"><span></span></a>
                            </div>
                        </div>
                ...
                <div class="col-md-3 col-sm-3 col-xs-12 product-item-box">
                    <div class="product-item product-resize">
                        <div class="image image-resize">
                            <a href="san-pham/dam-theu-hoa-thanh-lich.html" title="Đầm Th&#234;u Hoa Thanh Lịch ">
                                <img src="Uploads/shop139/images/Product/131305_0_fashion_1.jpg" class="img-responsive" />
                            </a>
                                <span class="promotion">-15%</span>
                        </div>
                        <div class="right-block">
                            <h2 class="name">
                                <a href="san-pham/dam-theu-hoa-thanh-lich.html" title="Đầm Th&#234;u Hoa Thanh Lịch ">Đầm Th&#234;u Hoa Thanh Lịch </a>
                            </h2>
                            <div class="ratings clearfix">
                                <div class="rating-box">
                                    <div class="rating">
                            ...
                            <div class="addtocart-button clearfix">
                                <a class="add-to-cart" href="javascript:void(0)" onclick="AddToCard(2660,1)"><span></span></a>
                                <a class="add-wishlist" href="#"><span></span></a>
                                <a class="add-compare" href="#"><span></span></a>
                            </div>
                        </div>
                ...
                <div class="col-md-3 col-sm-3 col-xs-12 product-item-box">
                    <div class="product-item product-resize">
                        <div class="image image-resize">
                            <a href="san-pham/dam-co-lo-vintage-bst-he.html" title="Đầm Cổ Lọ Vintage - BST H&#232;">
                                <img src="Uploads/shop139/images/Product/131736_fashion.jpg" class="img-responsive" />
                            </a>
                                <span class="promotion">-25%</span>
                        </div>
                        <div class="right-block">
                            <h2 class="name">
                                <a href="san-pham/dam-co-lo-vintage-bst-he.html" title="Đầm Cổ Lọ Vintage - BST H&#232;">Đầm Cổ Lọ Vintage - BST H&#232;</a>
                            </h2>
                            <div class="ratings clearfix">
                                <div class="rating-box">
                                    <div class="rating">
                            ...
                            <div class="addtocart-button clearfix">
                                <a class="add-to-cart" href="javascript:void(0)" onclick="AddToCard(2661,1)"><span></span></a>
                                <a class="add-wishlist" href="#"><span></span></a>
                                <a class="add-compare" href="#"><span></span></a>
                            </div>
                        </div>
                ...
                <div class="col-md-3 col-sm-3 col-xs-12 product-item-box">
                    <div class="product-item product-resize">
                        <div class="image image-resize">
                            <a href="san-pham/dam-co-tru-giot-nuoc.html" title="Đầm Cổ Trụ Giọt Nước">
                                <img src="Uploads/shop139/images/Product/120019_fashion.jpg" class="img-responsive" />
                            </a>
                                <span class="promotion">-0%</span>
                        </div>
                        <div class="right-block">
                            <h2 class="name">
                                <a href="san-pham/dam-co-tru-giot-nuoc.html" title="Đầm Cổ Trụ Giọt Nước">Đầm Cổ Trụ Giọt Nước</a>
                            </h2>
                            <div class="ratings clearfix">
                                <div class="rating-box">
                                    <div class="rating">
                            ...
                            <div class="addtocart-button clearfix">
                                <a class="add-to-cart" href="javascript:void(0)" onclick="AddToCard(2662,1)"><span></span></a>
                                <a class="add-wishlist" href="#"><span></span></a>
                                <a class="add-compare" href="#"><span></span></a>
                            </div>
                        </div>
...
<section class="product-content clearfix">
    ...
    <nav class="navbar navbar-default product-filter">
        ...
        <div class="limit">
            <span>Sản phẩm/trang</span>
            <select id="lblimit" name="lblimit" class="nb_item" onchange="window.location.href = this.options[this.selectedIndex].value">
                <option ng-if="selected==product.limit" value="{{product.pathLimit}}limit={{item}}" ng-repeat="item in product.ProductLimit">{{item}}</option>
            </select>
        </div>
        <div class="sort">
            <span>Sắp xếp</span>
            <select class="selectProductSort" id="lbsort" onchange="window.location.href = this.options[this.selectedIndex].value">
                <option ng-selected="item.Sort==product.sort&&item.Order==product.order" value="{{product.pathSort}}sort={{item.Sort}}&order={{item.Order}}" ng-repeat="item in product.ProductSortOrder">{{item.Name}}</option>
            </select>
        </div>
    </nav>
    <div class="product-block product-grid clearfix row">
        <div class="col-md-{{12/product.columnProduct}} col-sm-{{12/product.columnProduct}} col-xs-12 product-item-box" ng-repeat="item in product.Products">
            <div class="product-item product-resize">
                <div class="image image-resize">
                    <a href="/san-pham/{{item.Code}}.html" title="{{item.Name}}">
                        <img ng-src="{{item.Image}}" alt="{{item.Name}}" class="img-responsive" />
                    </a>
                    <span class="promotion" ng-if="item.IsPromotion==true">-{{item.Percent}}%</span>
                    <span class="hot" ng-if="item.IsHot==true&&item.IsPromotion==false">Hot</span>
                    <span class="new" ng-if="item.IsNew==true&&item.IsPromotion==false&&item.IsHot==false">Mới</span>
                    <span class="sale" ng-if="item.IsBest==true&&item.IsPromotion==false&&item.IsHot==false&&item.IsNew==false">Bán chạy</span>
                </div>
                <div class="right-block">
                    <h2 class="name">
                        <a href="/san-pham/{{item.Code}}.html" title="{{item.Name}}">{{item.Name}}</a>
                    </h2>
                    <div class="ratings clearfix">
                        <div class="rating-box">
                            <div class="rating">
                    ...
                    <div class="price">
                        <span class="price-new" ng-if="item.IsPromotion==true">{{item.PriceDiscount| number:0}}&nbsp;₫</span>
                        <span class="price-old" ng-if="item.IsPromotion==true">{{item.Price| number:0}}&nbsp;₫</span>
                        <span class="price-new" ng-if="item.IsPromotion==false">{{item.Price| number:0}}&nbsp;₫</span>
                    </div>
                    <div class="addtocart-button clearfix">
                        <a class="add-to-cart" href="javascript:void(0)" ng-click="AddToCard(item,1)"><span></span></a>
                        <a class="add-wishlist" href="#"><span></span></a>
                        <a class="add-compare" href="#"><span></span></a>
                    </div>
                </div>
    ...
    <div class="navigation" ng-if="product.pageCount>1">
        <ul class="pagination">
            <li>
            ...
            <li ng-class="{'active':$index==product.pageCurrent}" ng-repeat="item in pageCount"><a href="{{product.pathPage}}page={{$index+1}}">{{$index+1}}</a></li>
            <li>
                <a href="?page={{product.pageCount}}" aria-label="Next">
                    <span aria-hidden="true">&raquo;</span>
                </a>
            </li>
        </ul>
...
<!-- Mirrored from runecom22.runtime.vn/trang-chu.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 01 Jul 2017 06:53:41 GMT -->
</html>
<script type="text/javascript">
