...
function searchByMenu($scope, idLoaiSp){
	var url = "/storeManagerSystem/trangChu/searchByMenu/" + idLoaiSp;
...
function back($scope){
	var url = "/storeManagerSystem/trangChu" ;
	document.getElementById("LayoutForm").action = url;
	document.getElementById("LayoutForm").method = "POST";
	document.getElementById("LayoutForm").submit();
}
...
function chiTiet($scope, $window, idSanPham){
	var url = "/storeManagerSystem/trangChu/chiTietSP/" + idSanPham;
	document.getElementById("LayoutForm").action = url;
	document.getElementById("LayoutForm").method = "POST";
	document.getElementById("LayoutForm").submit();
}
...
function timKiemMenu($scope, $window, idLSP){
	var url = "/storeManagerSystem/trangChu/timKiemSanPham/" + idLSP;
	document.getElementById("LayoutForm").action = url;
...
function timKiem($scope, $window, idSanPham){
	var url = "/storeManagerSystem/trangChu/timKiem";
	document.getElementById("LayoutForm").action = url;
	document.getElementById("LayoutForm").method = "POST";
	document.getElementById("LayoutForm").submit();
}
...
function gioiThieu($scope, $window, idSanPham){
	var url = "/storeManagerSystem/trangChu/gioiThieu";
	document.getElementById("LayoutForm").action = url;
	document.getElementById("LayoutForm").method = "POST";
	document.getElementById("LayoutForm").submit();
}
...
function huongDan($scope, $window, idSanPham){
	var url = "/storeManagerSystem/trangChu/huongDan";
	document.getElementById("LayoutForm").action = url;
	document.getElementById("LayoutForm").method = "POST";
	document.getElementById("LayoutForm").submit();
}
...
function phanTrang($scope, $window, id){
	var url = "/storeManagerSystem/trangChu/phanTrang/"+id;
	document.getElementById("LayoutForm").action = url;
	document.getElementById("LayoutForm").method = "POST";
	document.getElementById("LayoutForm").submit();
}
...
function lienHe($scope){
	var url = "/storeManagerSystem/trangChu/lienHe";
	document.getElementById("LayoutForm").action = url;
	document.getElementById("LayoutForm").method = "POST";
	document.getElementById("LayoutForm").submit();
}
...
function dangKiLienHe($scope){
	...
	if (true == valid) {
		...
		var url = "/storeManagerSystem/trangChu/lienHe/insert";
		document.getElementById("LayoutForm").action = url;
		document.getElementById("LayoutForm").method = "POST";
		document.getElementById("LayoutForm").submit();
	}
...
function cart($scope, $window){
	var session_listProduct = $window.sessionStorage.getItem('session_listProduct');
	if(session_listProduct != null && session_listProduct != ""){
		var url = "/storeManagerSystem/trangChu/gioHang/" + session_listProduct;
	}else{
		var url = "/storeManagerSystem/trangChu/gioHang/0";
	}
	document.getElementById("LayoutForm").action = url;
	document.getElementById("LayoutForm").method = "POST";
	document.getElementById("LayoutForm").submit();
...
function buyCart($scope, $window){
	...
	if(valid == true){
		...
		if(session_listProduct != null && session_listProduct != ""){
			var url = "/storeManagerSystem/trangChu/thanhToan/" + session_listProduct;
			// Dong y thanh toan
